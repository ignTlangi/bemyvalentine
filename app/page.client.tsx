...
export default function ValentinesCard() {
  ...
  const [name] = useState(nameParam ? decodeURIComponent(nameParam) : 'someone special');
  ...
  const yesButtonScale = 1 + (noClickCount * 2);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-300 via-purple-300 to-red-300 flex items-center justify-center p-4 overflow-hidden relative">
      <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 max-w-2xl w-full text-center relative z-10">
        ...
        <div className="my-8 flex justify-center relative z-[10001]">
          {noClickCount === 0 && (
            <img 
        ...
        <p className="text-2xl md:text-3xl text-gray-700 mb-8 font-medium relative z-[10001]">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center justify-center mt-8 relative">
          ...
          {noClickCount < 6 && (
            <button
              ...
              className="bg-gray-300 text-gray-700 px-8 py-4 rounded-full text-xl font-bold hover:bg-gray-400 transition-all shadow-md active:scale-95 relative z-[10001]"
            >
              No 😔
            </button>
          )}
